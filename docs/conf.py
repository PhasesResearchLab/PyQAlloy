import os
from pyqalloy.core.pyqalloy import __version__
...
def linkcode_resolve_simple(domain, info):
    ...
    return "https://github.com/PhasesResearchLab/PyQAlloy/tree/main/%s.py" % filename
...
def linkcode_resolve(domain, info):
    ...
    tag = "v" + __version__
    return f"https://github.com/PhasesResearchLab/PyQAlloy/blob/{tag}/{filename}"